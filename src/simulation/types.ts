...
export interface SimulationSettings { motorJitter:number; leftEfficiency:number; rightEfficiency:number; sensorNoise:number; sensorDelay:number; disabledSensor:number|null; }
